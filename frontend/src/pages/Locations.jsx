        ...
        <div key={c} className="mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {locs.map((l) => {
              ...
              return (
                <div key={l.id} className="mv-card p-5">
                  <div className="flex items-center justify-between"><span className="font-semibold">{l.name}</span><StatusChip status="active" /></div>
